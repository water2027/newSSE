<template>
    <div id="bottomNavBar" class="nav-bar bottom-nav-bar root">
      <router-link
        class="nav"
        ...
        @click="changeTo('main')"
      >
        <div class="icon" style="background-image: url(https://img.icons8.com/?size=100&id=59809&format=png&color=000000)"></div>
        主页
      </router-link>
      <!-- <router-link
        class="nav"
      ...
      <router-link
        ...
        to="/heat"
      >
        <div class="icon" style="background-image: url(https://img.icons8.com/?size=100&id=60985&format=png&color=000000);"></div>
        热榜
      </router-link>
      <!-- <router-link
        to="/course"
      ...
      <router-link
        ...
        to="/notice"
      >
        <div class="icon" style="background-image: url(https://img.icons8.com/?size=100&id=87048&format=png&color=000000);"></div>
        通知
      </router-link>
      <!-- 新增 '我的' 下拉菜单 -->
      <div class="nav" @click="toggleMyMenu">
        <div class="icon" style="background-image: url(https://img.icons8.com/?size=100&id=85147&format=png&color=000000);"></div>
        我的
        <div class="my-dropdown" v-show="myMenuVisible">
            <router-link
                class="dropdown-item"
  ...
  const displayBool = computed(() => noticeNum.value === '0' ? 'none' : 'block');
  ...
  <style scoped>
  .selected {
    box-shadow: var(--color-selected-shadow-first) 0px 30px 60px -12px inset,
