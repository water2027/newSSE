...
<template>
    <div ref="root" class="root" @click="copyCode">
        <div class="postDetail">
            ...
            <h2>{{ post.Title }}</h2>
            <div id="content" ref="mdContainer" class="hasImgDiv" :style="mdContainerStyle"
                v-html="safeHTML(post.Content)"></div>
            ...
            <div class="postInfo">
                <span>{{ post.Browse }}
                    <svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="eye fill"
                ...
                <span>{{ post.Like }}
                    <svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="heart"
        ...
        <div class="comment">
            ...
            <div class="commentButton">
                ...
                <button v-if="commentButtonIsShow" @click="send">
                    发送
                </button>
                <input v-if="commentButtonIsShow" class="fileInput" type="file" @input="upload">
            </div>
            <div v-if="commentButtonIsShow" class="editorButton">
            ...
            <div v-if="commentButtonIsShow" id="mdEditorContainer">
                <textarea v-model="commentContent" placeholder="请输入正文" @input="autoResize"></textarea>
